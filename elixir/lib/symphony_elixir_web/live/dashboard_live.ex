defmodule SymphonyElixirWeb.DashboardLive do
  ...
  def render(assigns) do
    ~H"""
    <section class="dashboard-shell" aria-labelledby="dashboard-title" data-current-view={@current_view}>
      ...
      <% else %>
        ...
        <section id="diagnostics" class="ops-panel audit-log-panel" aria-labelledby="diagnostics-title">
