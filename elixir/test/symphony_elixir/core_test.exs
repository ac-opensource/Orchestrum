defmodule SymphonyElixir.CoreTest do
  ...
  test "normal worker exit schedules active-state continuation retry" do
    ...
    assert_due_after(due_at_ms, before_retry_ms, after_retry_ms, 1_000)
  end
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_after(due_at_ms, before_retry_ms, after_retry_ms, 40_000)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_after(due_at_ms, before_retry_ms, after_retry_ms, 10_000)
  end
  ...
  defp assert_due_after(due_at_ms, before_retry_ms, after_retry_ms, expected_delay_ms) do
    assert due_at_ms >= before_retry_ms + expected_delay_ms
    assert due_at_ms <= after_retry_ms + expected_delay_ms
  end
  ...
  test "in-repo WORKFLOW.md renders correctly" do
    ...
    assert prompt =~ "Linear's `Issue` GraphQL type does not expose a `links` field"
